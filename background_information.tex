...
TODO: math formula and image of waveform and frequency spectrum

A band-pass filter is a filter that rejects frequencies outside a given range. A bandpass filter has a center frequency and a bandwidth. This bandwidth is typically controlled by a "Q" parameter, which is the inverse of the bandwidth.
